...
const SKIP_FILES = new Set(['firebase.json', '.firebaserc', 'build-data.js', 'build-logo.js', 'serve.js', 'source-data.json', 'firebase-seed.json', 'package.json', 'package-lock.json', 'vercel.json']);
