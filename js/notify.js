...
const STR = {
  ar: {
    ...
    denied: 'الإشعارات مقفولة من إعدادات المتصفح', install: 'ثبّت التطبيق', installSub: 'افتح Daily Bake من شاشتك الرئيسية زي أي تطبيق', installBtn: 'تثبيت', later: 'لاحقاً',
  ...
  en: {
    ...
    denied: 'Notifications are blocked in your browser settings', install: 'Install the app', installSub: 'Open Daily Bake from your home screen like any app', installBtn: 'Install', later: 'Later',
